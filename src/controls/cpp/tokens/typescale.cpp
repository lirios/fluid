...
TypeScale::TypeScale(QObject *parent)
    : QObject(parent)
    , m_displayLarge(FluidStyle::TypeFace::Brand, 57, 64, QFont::Weight::Normal, -0.25)
    ...
    , m_headlineLarge(FluidStyle::TypeFace::Brand, 32, 40, QFont::Weight::Medium, 0.0)
    , m_headlineMedium(FluidStyle::TypeFace::Brand, 28, 36, QFont::Weight::Medium, 0.0)
    , m_headlineSmall(FluidStyle::TypeFace::Brand, 24, 32, QFont::Weight::Medium, 0.0)
    , m_titleLarge(FluidStyle::TypeFace::Brand, 22, 28, QFont::Weight::Normal, 0.0)
    , m_titleMedium(FluidStyle::TypeFace::Plain, 16, 24, QFont::Weight::Medium, 0.15)
    ...
    , m_bodyMedium(FluidStyle::TypeFace::Plain, 14, 20, QFont::Weight::Normal, 0.25)
...
{
    m_displayLarge =
            TypeScaleValue(FluidStyle::TypeFace::Brand, 57, 64, QFont::Weight::Medium, -0.25);
    m_displayMedium =
    ...
    m_titleMedium =
            TypeScaleValue(FluidStyle::TypeFace::Plain, 16, 24, QFont::Weight::DemiBold, 0.15);
    m_titleSmall =
            TypeScaleValue(FluidStyle::TypeFace::Plain, 14, 20, QFont::Weight::DemiBold, 0.1);
    m_bodyLarge = TypeScaleValue(FluidStyle::TypeFace::Plain, 16, 24, QFont::Weight::Medium, 0.5);
