...
GalleryPage {
    ...
    headline: qsTr("Colors")
    description: qsTr("Color tokens define the reference palette and semantic roles used by light and dark themes.")

    readonly property var paletteNames: ["black", "error0", "error10", "error100", "error20", "error30", "error40", "error50", "error60", "error70", "error80", "error90", "error95", "error99", "neutral0", "neutral10", "neutral100", "neutral12", "neutral17", "neutral20", "neutral22", "neutral24", "neutral30", "neutral4", "neutral40", "neutral50", "neutral6", "neutral60", "neutral70", "neutral80", "neutral87", "neutral90", "neutral92", "neutral94", "neutral95", "neutral96", "neutral98", "neutral99", "neutralVariant0", "neutralVariant10", "neutralVariant100", "neutralVariant20", "neutralVariant30", "neutralVariant40", "neutralVariant50", "neutralVariant60", "neutralVariant70", "neutralVariant80", "neutralVariant90", "neutralVariant95", "neutralVariant99", "primary0", "primary10", "primary100", "primary20", "primary30", "primary40", "primary50", "primary60", "primary70", "primary80", "primary90", "primary95", "primary99", "secondary0", "secondary10", "secondary100", "secondary20", "secondary30", "secondary40", "secondary50", "secondary60", "secondary70", "secondary80", "secondary90", "secondary95", "secondary99", "tertiary0", "tertiary10", "tertiary100", "tertiary20", "tertiary30", "tertiary40", "tertiary50", "tertiary60", "tertiary70", "tertiary80", "tertiary90", "tertiary95", "tertiary99", "white"]

    readonly property var semanticNames: ["background", "error", "errorContainer", "inverseOnSurface", "inversePrimary", "inverseSurface", "onBackground", "onError", "onErrorContainer", "onPrimary", "onPrimaryContainer", "onPrimaryFixed", "onPrimaryFixedVariant", "onSecondary", "onSecondaryContainer", "onSecondaryFixed", "onSecondaryFixedVariant", "onSurface", "onSurfaceVariant", "onTertiary", "onTertiaryContainer", "onTertiaryFixed", "onTertiaryFixedVariant", "outline", "outlineVariant", "primary", "primaryContainer", "primaryFixed", "primaryFixedDim", "scrim", "secondary", "secondaryContainer", "secondaryFixed", "secondaryFixedDim", "surface", "surfaceBright", "surfaceContainer", "surfaceContainerHigh", "surfaceContainerHighest", "surfaceContainerLow", "surfaceContainerLowest", "surfaceDim", "surfaceTint", "surfaceVariant", "tertiary", "tertiaryContainer", "tertiaryFixed", "tertiaryFixedDim"]
    ...
    component ColorTile: Rectangle {
        ...
        function contrastingBorderColor(color) {
            const luminance = 0.299 * color.r + 0.587 * color.g + 0.114 * color.b;
            return luminance > 0.55 ? Qt.rgba(29 / 255, 27 / 255, 32 / 255, 0.25) : Qt.rgba(1, 1, 1, 0.25);
        }
    ...
    component TokenSection: GalleryCard {
        id: tokenSection
        ...
        fullWidth: true
        title: tokenSection.sectionTitle
