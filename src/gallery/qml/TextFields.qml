...
Item {
    ...
    component ShowcaseCard: MD.GroupBox {
        Layout.fillWidth: true
        Layout.alignment: Qt.AlignTop
        Layout.columnSpan: page.cardSpan(textFieldGrid.columns)
    }
    ...
    MD.ScrollView {
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                MD.Label {
                    Layout.fillWidth: true
                    text: qsTr("Text fields let people enter and edit a single line of text. Choose a filled or outlined container to fit the surrounding hierarchy.")
                ...
                ShowcaseCard {
                    ...
                    ColumnLayout {
                        ...
                        MD.TextField {
                            ...
                            Layout.fillWidth: true
                            Layout.bottomMargin: textFieldGrid.columns > page.cardSpan(textFieldGrid.columns)
                                                 ? Math.max(0, emailField.implicitHeight - implicitHeight)
                                                 : 0
                        ...
                        MD.TextField {
                            ...
                            trailing: MD.IconButton {
                                text: passwordField.echoMode === TextInput.Password
                                      ? qsTr("Show password") : qsTr("Hide password")
                                type: MD.IconButton.Standard
                                size: MD.IconButton.ExtraSmall
                                icon.name: passwordField.echoMode === TextInput.Password
                                           ? MD.SymbolNames.symbolVisibility
                                           : MD.SymbolNames.symbolVisibilityOff
